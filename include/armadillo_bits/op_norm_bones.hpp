...
struct op_norm
  ...
  {
  template<typename T1> arma_hot inline static typename T1::elem_type vec_norm_1(const Proxy<T1>& P, const typename  arma_not_cx<typename T1::elem_type>::result* junk = nullptr);
  ...
  template<typename T1> arma_hot inline static typename T1::elem_type vec_norm_2(const Proxy<T1>& P, const typename  arma_not_cx<typename T1::elem_type>::result* junk = nullptr);
